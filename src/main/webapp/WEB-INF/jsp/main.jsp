...
<body>
    <div class="container">
        <div id="pf-hd">
           <div class="pf-logo"">
                <img  src="${pageContext.request.contextPath}/images/main/main_logo.png" alt="logo">
           </div>
            ...
            <div class="pf-user">
                <div class="pf-user-photo">
                    <img style="width: 40px;height: 40px;" src="${ctx}/images/main/xiaomao.jpg" alt="">
                </div>
            ...
            <div id="pf-sider">
                ...
                <ul class="sider-nav" id="sider-nav">
                 	  	   ...
                 	  	   <li>
		                            ...
		                            <span class="sider-nav-title">${datas.key.name}</span>
		                            <i class="iconfont">&#xe642;</i>
		                        </a>
		                        <c:forEach items="${datas.value}" var="seModule">
